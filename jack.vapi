...
namespace Jack {
	...
	public delegate int BufferSizeCallback (NFrames nframes, void* arg);
	[CCode (cname="JackGraphOrderCallback")]
	public delegate int GraphOrderCallback (void* arg);
	[CCode (cname="JackProcessCallback")]
	public delegate int ProcessCallback (NFrames nframes, void* arg);
	[CCode (cname="JackSampleRateCallback")]
	public delegate int SampleRateCallback (NFrames nframes, void* arg);
	[CCode (cname="JackXRunCallback")]
	public delegate int XRunCallback (void* arg);
	[CCode (cname="JackClientRegistrationCallback")]
	public delegate void ClientRegistrationCallback (string name, int reg, void* arg);
	...
	public delegate void InfoShutdownCallback (Status code, string reason, void* arg);
	[CCode (cname="JackLatencyCallback")]
	public delegate void LatencyCallback (LatencyCallbackMode mode, void* arg);
	[CCode (cname="JackPortConnectCallback")]
	public delegate void PortConnectCallback (PortId a, PortId b, int connect, void* arg);
	[CCode (cname="JackPortRegistrationCallback")]
	public delegate void PortRegistrationCallback (PortId port, int register, void* arg);
	[CCode (cname="JackPortRenameCallback")]
	public delegate void PortRenameCallback (PortId port, string old_name, string new_name, void* arg);
	...
	public delegate void* ThreadStartRoutine(void* arg);
	...
	public delegate int SyncCallback (TransportState state, Position pos, void* arg);
	public delegate void TimebaseCallback (TransportState state, NFrames nframes, Position pos, int new_pos, void* arg);
	...
	public class Client {
		...
		public Port? port_register (string port_name, string port_type, ulong flags, ulong buffer_size);
